...
import {ArrowLeft, Funnel, MoreHorizontal, MoreVertical, SlidersHorizontal} from "lucide-react";
  ...
  const [data, setData] = useState<Drafts[]>([
    {
      ...
      verificationPeriod: "8/21/15",
      totalQuestions: "10",
    },
    {
      courseName: "Summer Promotions",
      verificationPeriod: "8/30/14",
      totalQuestions: "05",
    },
    {
      courseName: "Office Policy",
      verificationPeriod: "1/28/17",
      totalQuestions: "20",
    },
    {
      courseName: "Marketing Campaigns",
      verificationPeriod: "2/11/12",
      totalQuestions: "08",
    },
    {
      courseName: "Customer Support",
      verificationPeriod: "12/10/13",
      totalQuestions: "10",
    },
    {
      courseName: "Vacation Policy",
      verificationPeriod: "10/28/12",
      totalQuestions: "15",
    },
  ]);
