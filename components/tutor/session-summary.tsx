        ...
        <div className="flex flex-col text-white  px-8 py-6 w-full max-w-[700px] mx-auto">
          ...
          <div className="text-sm text-white/90 space-y-2 font-urbanist font-medium text-[20px] leading-[100%] tracking-[0] text-center mb-6">
            ...
            <p>
              ...
              <span className="text-[#F9DB6F] font-urbanist font-medium text-[20px] leading-[100%] tracking-[0] text-centerunderline cursor-pointer">
                Warranty card
              </span>
              .
            </p>
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button
              variant="outline"
              className="border h-[48px] w-[194px] border-white bg-[#333435] text-white hover:text-white hover:bg-[#333435] font-urbanist font-medium text-[14px] leading-[100%] tracking-[0] px-6 py-2  rounded-[8px]"
