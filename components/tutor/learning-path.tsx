...
export default function LearningPaths() {
  ...
  return (
    <div className="flex text-white">
      <div className="flex flex-col w-full h-[100vh] overflow-auto py-9">
        <h1 className="font-urbanist font-medium text-[32px] leading-[100%] tracking-[0] py-6">
          Learning Paths
        </h1>

        <div className="flex flex-1 flex-col md:flex-row gap-4 just sm:flex-row pt-4 h-[80vh]">
          {/* Left sidebar */}
          <div className="relative w-fit pb-8">
            {/* SVG background */}
            <svg
            ...
            {/* Main card content */}
            <div className="relative z-10 w-80 mb-5 rounded-lg flex flex-col h-[calc(100vh-200px)]">
              <div className="space-y-4 px-4 py-4 flex-grow overflow-y-auto no-scrollbar text-white">
                ...
                {isLoading ? (
                  ...
                  enrolledPaths.map((path) => (
                    <div
                      key={path.id}
                      className="flex h-[101px] p-2 items-start mx-3 gap-[17px] rounded-2xl bg-[#0E0F11] opacity-100 hover:opacity-80 cusroor-pointer"
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="font-urbanist font-medium text-[12px] leading-[100%] text-[#828282] mt-1">
                          {typeof path.learning_path_id.category === "object"
                            ? (path.learning_path_id.category as any).name ||
                              "Unknown Category"
                            : path.learning_path_id.category ||
                              "Unknown Category"}
                        </div>
                        <div
                          className={`w-[118px] h-[29px] mt-5 flex items-center gap-[10px] rounded-[8px] px-[10px] py-[6px] font-urbanist font-semibold text-[14px] leading-[100%] bg-[#707070] text-white ${
                            sessionComplted
                              ? "bg-[#707070]"
              ...
              <div className="sticky bottom-0 w-full mt-auto justify-center items-center flex flex-row">
                <Button
